 ...
 */
package com.sc.science.nio.Selector;
        ...
        while (selector.select() > 0) {
            ...
            for (SelectionKey sk : selector.selectedKeys()) {
                ...
                if (sk.isAcceptable()) // ②
                {
                    ...
                    //sk.interestOps(SelectionKey.OP_ACCEPT);//没必要子渠道注册为可连接
                }
                // 如果sk对应的通道有数据需要读取
                if (sk.isReadable()) // ③
                {
                    ...
                    try {
                        ...
                        //sk.interestOps(SelectionKey.OP_READ);没必要因为一开始就已经注册 了读
                    }
                    ...
                    if (content.length() > 0) {
                        ...
                        for (SelectionKey key : selector.keys()) {
                            ...
                            if (targetChannel instanceof SocketChannel) {//去除第一次注册的ServerSocketChannel
                                // 将读到的内容写入该Channel中
